// lib/screens/social_teaching_screen.dart
...
class SocialTeachingScreen extends StatelessWidget {
  const SocialTeachingScreen({super.key});
      ...
      body: Container(
        ...
        child: AnimationLimiter(
          child: ListView.builder(
            ...
            itemCount: socialTeachingTopics.length,
            itemBuilder: (context, index) {
              final topic = socialTeachingTopics[index];
                  ...
                  child: FadeInAnimation(
                    child: Card(
                      ...
                      child: ListTile(
                        ...
                        leading: Icon(
                          topic['icon'] as IconData? ?? Icons.groups_rounded,
                          size: 30,
                        ...
                        onTap: () {
                          ...
                          Navigator.push(
                            ...
                            SlowCupertinoPageRoute(
                              builder: (context) => SocialTeachingViewerScreen(
                                allTopics: socialTeachingTopics,
                                initialIndex: index,
                              ),
                            ),
                          );
...
class SocialTeachingViewerScreen extends StatefulWidget {
  final List<Map<String, dynamic>> allTopics;
  final int initialIndex;

  const SocialTeachingViewerScreen({
    super.key,
  ...
  @override
  State<SocialTeachingViewerScreen> createState() =>
      _SocialTeachingViewerScreenState();
}

class _SocialTeachingViewerScreenState
    extends State<SocialTeachingViewerScreen> {
  ...
  Future<void> _toggleFavorite() async {
    ...
    final favoriteId = 'socialTeaching_${currentTopic['title']}';

    final favoriteItem = FavoriteItem(
      id: favoriteId,
      type: FavoriteType.socialTeaching,
      content: {
        'title': currentTopic['title'],
        'categoryTitle': 'ማሕበራዊ ትምህርቲ',
      },
    ...
    return Scaffold(
      ...
      body: PageView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return _SocialTeachingDetailPage(
...
class _SocialTeachingDetailPage extends StatelessWidget {
  final String title;
  final List<Map<String, String>> content;

  const _SocialTeachingDetailPage({
    required this.title,
